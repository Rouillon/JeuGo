...
/* 
   Ce code est le code test de la classe Jeu
   Il faut le copier dans une classe Test de Test Packages
   Nous n'avons pas réussi à vérsionner le package donc le code se trouve ici
*/
